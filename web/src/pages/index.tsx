        ...
        <article className={styles.menuLateral} >
          <section className={styles.perfil}>
            <Image className={styles.img}
              ...
              height={50}
            />
            <div className={styles.h6}>Ana Jhully Fontes</div>
            <div className={styles.descricao}>ana.queiros@alunos.ufersa.edu.br</div>
          </section>
            ...
            <div className={styles.main}>
              ...
              <div className={styles.camptitulo}>
                <div className={styles.campinfo}> 
                  ...
                  <div className={styles.h3}>Red Hot Chili Peppers.</div>
                  <div className={styles.descricao2}>
                  Pegue o fone, relaxe e curta as melhores músicas da melhor banda da Califórnia.
                  </div>
                  <div>
          ...
          <section className={styles.body}>
            ...
            <div className={styles.faixas}>
              ...
              <div className={styles.controlefaixa}>
                <div className={styles.titulofaixa}><samp className={styles.numFaixa}>01</samp> Scar Tissue</div>
                <div className={styles.tituloAlbum}> RHCP Hits</div>
              ...
              <div className={styles.controlefaixa2}>
                <div className={styles.titulofaixa}><samp className={styles.numFaixa}>02</samp>Californication</div>
                <div className={styles.tituloAlbum}> RHCP Hits</div>
                <div className={styles.iconFaixa}>
                  <img className={styles.iconBody} src="/imagens/get_app.png" width={18} height={18}/>
              ...
              <div className={styles.controlefaixa}>
                <div className={styles.titulofaixa}><samp className={styles.numFaixa}>03</samp>By The Way</div>
                <div className={styles.tituloAlbum}> RHCP Hits</div>
                <div className={styles.iconFaixa}>
                  <img className={styles.iconBody} src="/imagens/get_app.png" width={18} height={18}/>
                  <img className={styles.iconBody} src="/imagens/favorite 2.png" width={18} height={18}/>
        ...
        <section className={styles.controles}>
            <section className={styles.infomusica}>
                ...
                <div className={styles.titulomusica}>
                  <div className={styles.h6}>Californication</div>
                  <div className={styles.descricao}>RHCP Hits</div>
                </div>
